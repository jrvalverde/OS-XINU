...
struct BootInfo {
        char    myip[BOOTNAMELENGTH];
        char    defaultroute[BOOTNAMELENGTH];
        char    timeserver[BOOTNAMELENGTH];
        char    rfserver[BOOTNAMELENGTH];
        char    tftpserver[BOOTNAMELENGTH];
        char    dnsserver[BOOTNAMELENGTH];
#ifdef WIRELESS
        char    wirelessip[BOOTNAMELENGTH];
#endif
        char    bootfile[SZFNAME];
        IPaddr  subnetmask;
};
