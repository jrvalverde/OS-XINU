...
/* ipc/network software */
	...
	/* ConcurrenC errors */
	"Too many tasks",			/* 70 - CENOTASK */
	"Too many ports",			/* 71 - CENOPORT */
	"Too many semaphores",			/* 72 - CENOSEM */
	"Bad task id",				/* 73 - CEBADTID */
	"Bad port id",				/* 74 - CEBADPT */
	"Bad semaphore id",			/* 75 - CEBADSEM */
	"Bad buffer pool id",			/* 76 - CEBADBP */
	"Call not allowed in ConcurrenC",	/* 77 - CENOTALLOWED */
	"Signal not allowed in ConcurrenC",	/* 78 - CEILLSIG */
	"Task has message",			/* 79 - CEHASMSG */
	"Task not suspended",			/* 80 - CENOTSUSP */
	"Task not on ready list",		/* 81 - CENOTREADY */
};
