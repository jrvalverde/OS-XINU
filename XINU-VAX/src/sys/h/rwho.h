...
#define	RWMAXP		800		/* max packet length accepted	*/
#define	RWMINP		60		/* size of rwho pac, no users	*/
#define	RWDELAY		180		/* delay for output in seconds	*/
#define	RWCDOWN		360		/* consider down if this old	*/
...
struct	rwent	{			/* rwho cache entry		*/
	...
	long	rwload[3];		/* Load averages as in uptime	*/
