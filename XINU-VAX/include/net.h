...
#define	NETBUFS		25		/* number of network buffers	*/
#ifndef	Ndg
#define	NETQS		1		/* number of xinu ports used to	*/
#else					/*  demultiplex udp datagrams	*/
#define	NETQS		Ndg
#endif
#define	NETQLEN		15		/* size of a demux queue	*/
...
#define	NETISTK		1024		/* stack size for network input	*/
#define	NETOSTK		1900		/* stack size for network output*/
