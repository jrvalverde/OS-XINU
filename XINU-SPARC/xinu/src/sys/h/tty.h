...
#define	EBUFLEN		64		/* size of echo queue		*/
...
struct	tty	{			/* tty line control block	*/
	...
	int	imode;			/* IMRAW, IMCBREAK, IMCOOKED	*/
...
#define TCSETICRLF	14		/* map \r\n to \n on input	*/
#define TCRSTICRLF	15		/* map \r\n to \r\n on input	*/
#define TCSETOCRLF	16		/* map \n to \r\n on output	*/
#define TCRSTOCRLF	17		/* map \n to \n on output	*/
