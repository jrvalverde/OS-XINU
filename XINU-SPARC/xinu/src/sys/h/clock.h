...
#define	OBIO_CLOCK0_ADDR	0xF3000000	/* address of clock in obio space */

#define	CLOCK0_ADDR 0xFFFF0000	/* virtual address we map clock to be at */
...
#define	CLOCK0 ((struct intersil7170 *)(CLOCK0_ADDR))
#endif !LOCORE
 ...
 */
#define	CLOCK1_ADDR	0xFFFF27F8		/* virtual address for clock1 */
...
#define	COUNTER_ADDR		0xFFFFA000
...
/* defined in clkinit.c */
extern unsigned long	clktime; /* current time in seconds since 1/1/70 */
extern unsigned long	realtime;/* 1/100 second counter since boot time */
