...
#define	ULRPORTMIN	600	/* lowest UDP reserved "port" number	*/
#define	ULRPORTMAX	699	/* highest UDP reserved "port" number	*/
...
#define	UP_RPC		111	/* Sun Remote Procedure Call		*/
...
struct	upq	{			/* UDP demultiplexing info	*/
	...
	unsigned 	up_port;	/* local UDP port number	*/
