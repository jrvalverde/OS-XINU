...
#define	TMASK		0x7	/* timer event mask, low-order 3 bits */
...
#define	TCP_MINRXT	   100	/* 1 second min rexmt time		*/
#define	TCP_ACKDELAY	    40	/* 0.4 sec ACK delay, if TCBF_DELACK	*/
