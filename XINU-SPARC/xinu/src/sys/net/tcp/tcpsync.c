     ...
     struct	tcb	*ptcb;
{
    ...
    ptcb->tcb_lwack = ptcb->tcb_iss;	/* ack seq of last window update */
    ...
    ptcb->tcb_rudq = ptcb->tcb_ruhq = EMPTY;	/* receive urgent data queue */
    ptcb->tcb_sudq = ptcb->tcb_suhq = EMPTY;	/* send urgent data queue    */
    ...
    ptcb->tcb_rexmt = TCP_MINRXT;   /* in sec/100   */
